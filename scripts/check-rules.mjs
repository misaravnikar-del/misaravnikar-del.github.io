...
if (badTerm.length) fail.push(`2. Termin ni akcija (nizkocenovnik pod praga letališča, klasični prevoznik pod −${MIN_DISCOUNT_FULL} %, in ni pod ${ALWAYS_UNDER} €): ${cap(badTerm)}`);
